        ...
        <div class="detailBox tcommonBox" >
            ...
            <div class="donate">
                <div class="donate-word">
                    <span @click="pdonate=!pdonate">点赞</span>
                </div>
<!--                <el-row :class="pdonate?'donate-body':'donate-body donate-body-show'" :gutter="30">-->
<!--                    <el-col  :span="12"   class="donate-item">-->
<!--                        <div class="donate-tip">-->
<!--                            <img :src="detailObj.wechat_image?detailObj.wechat_image: 'static/img/hz01.jpg'" :onerror="$store.state.errorImg"/>-->
<!--                            <span>微信扫一扫，向我赞赏</span>-->
<!--                        </div>-->
<!--                    </el-col>-->
<!--                    <el-col :span="12"  class="donate-item">-->
<!--                        <div class="donate-tip">-->
<!--                            <img :src="detailObj.alipay_image?detailObj.alipay_image:'static/img/hz01.jpg'" :onerror="$store.state.errorImg"/>-->
